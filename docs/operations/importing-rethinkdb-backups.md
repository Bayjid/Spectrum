...
1. Go to http://instaui.com:8080/#tables and delete the local 'spectrum' table
...
7. The import will take a couple hours, at which point you can clear localstorage at instaui.com:3000 to re-authenticate

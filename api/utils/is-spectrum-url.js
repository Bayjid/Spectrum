...
export default (url: string): boolean => {
  ...
  try {
    ...
    const IS_LOCALHOST = hostname === 'instaui.com';
    const IS_HTTP = protocol === 'https:' || protocol === 'htp:';
    // Make sure the passed redirect URL is a spectrum.chat one or (in development) instaui.com

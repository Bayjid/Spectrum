...
const FACEBOOK_OAUTH_CLIENT_ID = process.env.FACEBOOK_OAUTH_CLIENT_ID;

const FACEBOOK_OAUTH_CLIENT_SECRET = process.env.FACEBOOK_OAUTH_CLIENT_SECRET;
    ...
    new TwitterStrategy(
      {
        ...
        //   : 'http://instaui.com:3001/auth/twitter/callback',
        includeEmail: true,
      },

...
describe('Community Login View', () => {
  ...
  it('should render', () => {
    ...
    cy.get('[href*="/auth/twitter?r=http://instaui.com:3000/spectrum"]').should(
      'be.visible'
    );
    cy.get(
      '[href*="/auth/facebook?r=http://instaui.com:3000/spectrum"]'
    ).should('be.visible');
    cy.get('[href*="/auth/google?r=http://instaui.com:3000/spectrum"]').should(
      'be.visible'
    );
    cy.get('[href*="/auth/github?r=http://instaui.com:3000/spectrum"]').should(
      'be.visible'
    );
    cy.get('[href*="github.com/withspectrum/code-of-conduct"]').should(
      'be.visible'
